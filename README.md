 # MERN BLOG  
Cookbook Collective is a web application built with the MERN stack (MongoDB, Express, React, Node.js). It allows users to share and discover recipes. Users can create an account, submit their favorite recipes, and explore recipes submitted by others. The application features user authentication, CRUD operations for recipes, and a user-friendly interface for managing your personal cookbook.
