    ...
    <div className="Inclusive-register-page">
      ...
      <div className="register-big-wrapper">
        ...
        <div className="register-banner-section ">
          ...
          <img src="https://www.ikea.com/ext/ingkadam/m/72c6fdf1ecf107f4/original/PH186810.jpg?f=s" alt="banner" width="500px" height="600" />
        </div>
        ...
        <div className="section-wrapper">
          ...
          <div className="top-register-explain">
            <h2>Welcome to CookBook Collective </h2>
